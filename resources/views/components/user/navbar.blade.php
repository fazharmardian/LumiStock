    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            ...
            <div class="w-full max-w-60 sm:max-w-2xl relative">
                <input class="w-full pr-10 rounded-lg bg-darkblue-300 border-none focus:ring-whiteblue-500 transition duration-300 ease-in-out
                text-slate-200 placeholder-slate-200 focus:placeholder-slate-400" type="search" placeholder="Search">
            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3 mr-4">
                    ...
                    <div class="z-50 hidden my-4 mr-6 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        id="dropdown-user">
