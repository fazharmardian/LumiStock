                ...
                <div class="relative overflow-x-auto sm:rounded-lg">
                    <div class="flex items-center justify-between flex-wrap gap-4 pb-4 md:flex-nowrap">
                        <div class="relative flex-grow md:w-auto">
                            ...
                            <form method="GET" action="{{ route('pending.index') }}" class="relative w-full">
                        ...
                        <div class="flex items-center justify-end gap-x-2">
                            <form method="GET" action="{{ route('pending.index') }}"
                    ...
                    <x-admin.requestTable :requests="$requests" :green :approved="true"/>
